...
Everything the README leaves out: how the scanner and the views actually work, what was measured,
and the Studio Pro API behaviours that cost the most time to find. Read it if you are changing the
code or writing an extension of your own — several of these are constraints rather than trivia.
